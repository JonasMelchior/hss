...
This Project aims to implement an HSS with Java using the quarkus framework with the jdiameter extension.
...
You can then execute your native executable with: `./target/hss-1.0.0-SNAPSHOT-runner`
